...
from urfu.commands.upgrade.compose import upgrade_from
from urfu.core.hooks import Filter  # pylint: disable=unused-import
from urfu.exceptions import UrfuError
from urfu.tasks import BaseComposeTaskRunner
...
class ComposeTaskRunner(BaseComposeTaskRunner):
    ...
    def run_task(self, service: str, command: str) -> int:
        ...
        for docker_compose_path in self.docker_compose_job_files:
            path = urfu_env.pathjoin(self.root, docker_compose_path)
...
def launch(
    ...
    for host in hooks.Filters.APP_PUBLIC_HOSTS.iterate(context_name):
        public_app_host = urfu_env.render_str(

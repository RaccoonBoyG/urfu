...
# docs/urfu.html#versioning for information on the versioning scheme.
__version__ = "15.3.4"
...
# The app name will be used to define the name of the default urfu root and
...
# name.
__app__ = os.environ.get("URFU_APP", "urfu")

# Package version, as installed by pip, does not include the version suffix.
# Otherwise, nightly plugins will automatically install non-nightly Urfu
# version.

...
datas = [("./urfu/templates", "./urfu/templates")]
hidden_imports = []

# Auto-discover plugins and include patches & templates folders
for entrypoint_version in ["urfu.plugin.v0", "urfu.plugin.v1"]:
...
hidden_imports.append("urfults.__about__")
...
# pyinstaller --onefile --name=urfu --add-data=./urfu/templates:./urfu/templates ./bin/main.py
